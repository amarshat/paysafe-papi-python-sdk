"""
Payment resource for the Paysafe Python SDK.
"""
...
class Payment:
    """
    Payment operations for the Paysafe API.
    
    This class provides methods to create, retrieve, and manage payments.
    """
    ...
    def create(self, payment: Union[PaymentModel, Dict[str, Any]]) -> PaymentModel:
        """
        ...
        response = self.client.post(self.RESOURCE_PATH, data=payment_data)
    ...
    def retrieve(self, payment_id: str) -> PaymentModel:
        """
        ...
        response = self.client.get(f"{self.RESOURCE_PATH}/{payment_id}")
    ...
    def cancel(self, payment_id: str) -> PaymentModel:
        """
        Cancel a payment.
        ...
        response = self.client.post(f"{self.RESOURCE_PATH}/{payment_id}/cancel")
    ...
    def capture(self, payment_id: str, amount: Optional[int] = None) -> PaymentModel:
        """
        ...
        response = self.client.post(f"{self.RESOURCE_PATH}/{payment_id}/capture", data=data)
